<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    <div>
      <label for="app-name" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Full Name <span class="text-red-500">*</span></label>
      <input
        id="app-name"
        v-model="form.name"
        type="text"
    ...
    <div>
      <label for="app-email" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Email <span class="text-red-500">*</span></label>
      <input
        id="app-email"
        v-model="form.email"
        type="email"
    ...
    <div>
      <label for="app-position" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Position <span class="text-red-500">*</span></label>
      <input
        id="app-position"
        ...
        required
        readonly
        class="w-full px-3 py-2 text-sm rounded border border-[var(--color-surface-200)] dark:border-dm-border-alt bg-[var(--color-surface-50)] dark:bg-dm-alt text-[var(--color-surface-800)] dark:text-dm-text outline-none cursor-default"
      />
    </div>

    <div>
      <label for="app-affiliation" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Current Affiliation</label>
      <input
        id="app-affiliation"
    ...
    <div>
      <label for="app-interests" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Research Interests <span class="text-red-500">*</span></label>
      <textarea
        id="app-interests"
    ...
    <div>
      <label for="app-message" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">Message / Cover Letter</label>
      <textarea
        id="app-message"
    ...
    <div>
      <label for="app-cv" class="block text-sm text-[var(--color-surface-600)] dark:text-dm-muted mb-1">CV/Resume Link</label>
      <input
        id="app-cv"
        v-model="form.cvLink"
        type="url"
