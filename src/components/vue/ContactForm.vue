<template>
  <form @submit.prevent="handleSubmit" class="space-y-4">
    <div>
      <label for="name" class="block text-sm text-[var(--color-surface-600)] dark:text-[#8b949e] mb-1">Name</label>
      <input
        id="name"
        v-model="form.name"
        type="text"
    ...
    <div>
      <label for="email" class="block text-sm text-[var(--color-surface-600)] dark:text-[#8b949e] mb-1">Email</label>
      <input
        id="email"
        v-model="form.email"
        type="email"
    ...
    <div>
      <label for="subject" class="block text-sm text-[var(--color-surface-600)] dark:text-[#8b949e] mb-1">Subject</label>
      <input
        id="subject"
    ...
    <div>
      <label for="message" class="block text-sm text-[var(--color-surface-600)] dark:text-[#8b949e] mb-1">Message</label>
      <textarea
        id="message"
